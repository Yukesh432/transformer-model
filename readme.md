...
Finetuning is the process of retraining the model on specific task. Once we pretrain a model on large corpus of data, the features are encoded in an embedding vector.
