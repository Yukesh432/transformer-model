...
Finetuning is the process of retraining the model on specific task.Once we pretrain a model on large corpus of data, the features are encoded in an embedding vector which can be used as a checkpoint for retraining the model in specific rtask
